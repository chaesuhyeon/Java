...
class Student4{
    ...
    //groupingBy()에서 사용
    enum Level {HIGH, MID, LOW}; // 성적을 상,중,하 세 단계로 구분
}
...
public class Ex_14_11 {
    public static void main(String[] args) {
        ...
        System.out.printf("%n3. 단순 그룹화 + 통계(성적별로 학생수)%n");
        ...
        Map<Integer, Map<Integer, Student4>> topStuByHakAndBan =
                Stream.of(stuArr)
                        .collect(groupingBy(Student4::getHak, groupingBy(Student4::getBan,
                                collectingAndThen(
